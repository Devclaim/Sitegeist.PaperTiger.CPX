...
/**
 * @implements ContentNodeRendererInterface<EmailFormField,Document,Site>
 */
final class EmailFormFieldRenderer implements ContentNodeRendererInterface
{
    ...
    {
        $formField = ObjectPropertyGraphMapper::map($context->node, $context->subgraph, EmailFormField::class);
